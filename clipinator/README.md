...
- `-es, --embedded-subtitles` - Index of embedded subtitle stream to use
 - `-pf, --pick-font` - Flag. If used, a menu will be displayed for you to pick a custom font from your system for subtitles. The first option generates an image with samples of all the available fonts.
